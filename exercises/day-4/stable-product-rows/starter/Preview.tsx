  ...
  return (
    <section className="lesson-card exercise-header-card">
      <div className="exercise-header-copy">
        ...
        <code className="exercise-file-path">exercises/day-4/stable-product-rows/starter/entry.tsx</code>
      </div>

      <div className="exercise-task-block exercise-task-block-inline">
        <p className="eyebrow">Todo</p>
        <strong>Stop the product rows from rerendering unnecessarily</strong>
