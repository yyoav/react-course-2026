  ...
  return (
    <div className="keys-example">
      ...
      <div className="explanation">
        ...
        <ul>
          <li>
            <strong>Stable Keys:</strong> Each item has a unique ID (101, 102,
            103) that doesn't change when items are added or removed.
          </li>
          <li>
            <strong>Correct State Preservation:</strong> When you delete an
            item, React knows exactly which component to remove because the key=
            {"{"}id{"}"}
            stays with the item.
          </li>
          <li>
            <strong>No State Confusion:</strong> Input values stay with the
            correct items because React tracks components by their keys, not
            their position.
          </li>
        </ul>
      </div>
      ...
      <div className="tip-box">
        ...
        when rendering lists in React. Never use array indices for lists that
        can change (add, remove, or reorder items).
      </div>
    </div>
  );
}
